...
pub fn main() !void {
    ...
    var cli = CLIBuilder.init(allocator, "zio", "0.2.4", "A blazing-fast, cross-platform file system utility built in Zig — designed for efficiency, reliability, and simplicity.");
    defer cli.deinit();
